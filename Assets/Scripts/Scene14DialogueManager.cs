...
public class Scene14DialogueManager : MonoBehaviour
{
    public TextAsset AetherInkFile;
    public TextAsset GaledricInkFile;
    public TextAsset XzciarInkFile;
    ...
    void Start()
    {
        ...
        {
            story = new Story(AetherInkFile.text);
        }
        ...
        {
            story = new Story(GaledricInkFile.text);
        }
        else
        {
            story = new Story(XzciarInkFile.text);
        }
