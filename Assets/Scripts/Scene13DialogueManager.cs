...
public class Scene13DialogueManager : MonoBehaviour
{
    public TextAsset HollyInkFile;
    public TextAsset BelladonnaInkFile;
    public TextAsset SpiderLilyInkFile;
    public TextAsset IvyInkFile;
    public TextAsset CherryBlossomInkFile;
    ...
    void Start()
    {
        ...
        {
            story = new Story(HollyInkFile.text);
        }
        else if(EsteemScript.SpiderLilyEsteemCount > EsteemScript.HollyEsteemCount &&
            EsteemScript.SpiderLilyEsteemCount > EsteemScript.IvyEsteemCount &&
            EsteemScript.SpiderLilyEsteemCount > EsteemScript.BelladonnaEsteemCount &&
            EsteemScript.SpiderLilyEsteemCount > EsteemScript.cherryBlossomEsteemCount)
        {
            story = new Story(SpiderLilyInkFile.text);
        }
        else if(EsteemScript.IvyEsteemCount > EsteemScript.HollyEsteemCount &&
            EsteemScript.IvyEsteemCount > EsteemScript.SpiderLilyEsteemCount &&
            EsteemScript.IvyEsteemCount > EsteemScript.BelladonnaEsteemCount &&
            EsteemScript.IvyEsteemCount > EsteemScript.cherryBlossomEsteemCount)
        {
            story = new Story(IvyInkFile.text);
        }
        else if (EsteemScript.BelladonnaEsteemCount > EsteemScript.HollyEsteemCount &&
            EsteemScript.BelladonnaEsteemCount > EsteemScript.SpiderLilyEsteemCount &&
            EsteemScript.BelladonnaEsteemCount > EsteemScript.IvyEsteemCount &&
            EsteemScript.BelladonnaEsteemCount > EsteemScript.cherryBlossomEsteemCount)
        {
            story = new Story(BelladonnaInkFile.text);
        }
        else
        {
            story = new Story(CherryBlossomInkFile.text);
        }
