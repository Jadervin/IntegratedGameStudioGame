...
public class Scene16LoveDialogueManager : MonoBehaviour
{
    public TextAsset AetherEpilogueInkFile;
    public TextAsset GaledricEpilogueInkFile;
    public TextAsset XzciarEpilogueInkFile;
    ...
    void Start()
    {
        ...
        {
            story = new Story(AetherEpilogueInkFile.text);
        }
        else if (EsteemScript.GaledricEsteemCount > EsteemScript.XzciarEsteemCount &&
            EsteemScript.GaledricEsteemCount > EsteemScript.AetherEsteemCount)
        {
            story = new Story(GaledricEpilogueInkFile.text);
        }
        else
        {
            story = new Story(XzciarEpilogueInkFile.text);
        }
